...
function selectSeatResult(data) {
  ...
  if (tableView) {
    ...
    // El ancho real de #tableView solo se puede medir una vez que dejó de
    // ser display:none — por eso el escalado se dispara acá, no antes.
    if (typeof scaleTableForViewport === 'function') {
      scaleTableForViewport();
    }
  }
}
